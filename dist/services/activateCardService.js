...
export function activateCard(cardId, securityCode, password) {
    return __awaiter(this, void 0, void 0, function () {
        var cryptr, card, decriptedCVC, encriptedPassword, updatedCard;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    card = _a.sent();
                    decriptedCVC = cryptr.decrypt(card.securityCode);
                    encriptedPassword = cryptr.encrypt(password);
                    if (!card) {
                    ...
                    updatedCard = __assign(__assign({}, card), { password: encriptedPassword, isBlocked: false });
