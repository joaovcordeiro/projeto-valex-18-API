...
export function paymentCard(_a) {
    var cardId = _a.cardId, cardPassword = _a.cardPassword, businessesId = _a.businessesId, amount = _a.amount;
    return __awaiter(this, void 0, void 0, function () {
        var cryptr, card, decryptedCardPassword, business, cardBalance, payment;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, businessRepository.findById(businessesId)];
                case 2:
                    business = _b.sent();
                    return [4 /*yield*/, cardUtils.getCardBalance(cardId)];
                case 3:
                    cardBalance = (_b.sent()).balance;
                    if (!card) {
                    ...
                    return [4 /*yield*/, paymentRepository.insert(payment)];
                case 4:
                    _b.sent();
