...
export function createCard(apiKey, cardType, employeeId) {
    return __awaiter(this, void 0, void 0, function () {
        var cryptr, company, employee, cardExistenceVerfication, cvc, encriptedCVC, card;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    cardExistenceVerfication = _a.sent();
                    cvc = cardUtils.generateCVC();
                    encriptedCVC = cryptr.encrypt(cvc);
                ...
                case 4:
                    _a.sent();
                    return [2 /*return*/, { card: card, cvc: cvc }];
            }
        });
    });
}
